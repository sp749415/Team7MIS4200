...
{
    public class employeeInfoes1Controller : Controller
    {
        ...
        // GET: employeeInfoes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: employeeInfoes1/Create
